...
const FormConfig = {
    "set-iters": {
        "name": "Set Iterations",
        "message": `This sets the number of iterations computed, N. The default is ${
    ...
    "parallelogram": {
        ...
        "message": "This window sets the tiling to the standard tiling by parallelograms with " +
    ...
    "triangle": {
        ...
        "message": "This window sets the tiling to the standard tiling by triangulated " +
    ...
    "brick": {
        "name": "Brick Tiling",
        "message": "This window constructs the tiling by square bricks with offset T, a real " +
    ...
    "two-square": {
        ...
        "message": "This window sets the tiling to two-square tiling with side-lengths " +
