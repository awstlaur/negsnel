...
Octagon.prototype.getOpposite = function (i) {
    switch (i) {
        case 0:
            return new TilingEdge(new Octasquare(this.tiling, this.a, this.b), 3);
        case 1:
            return new TilingEdge(new Octagon(this.tiling, this.a + 1, this.b), 5);
        case 2:
            return new TilingEdge(new Octasquare(this.tiling, this.a, this.b + 1), 0);
        case 3:
            return new TilingEdge(new Octagon(this.tiling, this.a, this.b + 1), 7);
        case 4:
            return new TilingEdge(new Octasquare(this.tiling, this.a - 1, this.b + 1), 1);
        case 5:
            return new TilingEdge(new Octagon(this.tiling, this.a - 1, this.b), 1);
        case 6:
            return new TilingEdge(new Octasquare(this.tiling, this.a - 1, this.b), 2);
        case 7:
            return new TilingEdge(new Octagon(this.tiling, this.a, this.b - 1), 3);
        default:
