...
export default function UpTriangle (tiling, a, b) {
    ...
    this.v = [
        new Point(0, 0), new Point(1, 0), new Point(this.tiling.x, this.tiling.y)
    ];
...
UpTriangle.prototype.getOpposite = function (i) {
    switch (i) {
        case 0: return new TilingEdge(new DownTriangle(this.tiling, this.a, this.b - 1), 1);
        case 1: return new TilingEdge(new DownTriangle(this.tiling, this.a, this.b), 2);
        case 2: return new TilingEdge(new DownTriangle(this.tiling, this.a - 1, this.b), 0);
        default:
