...
Octasquare.prototype.getOpposite = function (i) {
    switch (i) {
        case 0:
            return new TilingEdge(new Octagon(this.tiling, this.a, this.b - 1), 2);
        case 1:
            return new TilingEdge(new Octagon(this.tiling, this.a + 1, this.b - 1), 4);
        case 2:
            return new TilingEdge(new Octagon(this.tiling, this.a + 1, this.b), 6);
        case 3:
