...
Hexagon.prototype.getOpposite = function (i) {
    switch (i) {
        case 0:
            return new TilingEdge(new HexDownTriangle(this.tiling, this.a, this.b), 2);
        case 1:
            return new TilingEdge(new HexUpTriangle(this.tiling, this.a, this.b + 1), 1);
        case 2:
            return new TilingEdge(new HexDownTriangle(this.tiling, this.a - 1, this.b), 0);
        case 3:
            return new TilingEdge(new HexUpTriangle(this.tiling, this.a - 1, this.b), 2);
        case 4:
            return new TilingEdge(new HexDownTriangle(this.tiling, this.a - 1, this.b - 1), 1);
        case 5:
            return new TilingEdge(new HexUpTriangle(this.tiling, this.a, this.b), 0);
        default:
