function TilingEdge(polygon, index){
  this.p = polygon;
  if (index>=0){
    this.i=(index % this.p.numSides());
  }else{ 
    this.i=p.numSides() - (index % this.p.numSides());
  }
}
...
/* I'm not sure this is even used, and it's exactly like nextEdge() in the original java code... */
